...
HD_PWD='G:/Facultate/Anul 3/Semestrul 1/SSC/Project/keyboard_comm/keyboard_comm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_ctrl.tcl -notrace
