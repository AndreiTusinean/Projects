...
HD_PWD='G:/Facultate/Anul 3/Semestrul 1/SSC/Project/keyboard_comm/keyboard_comm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_ctrl.tcl
